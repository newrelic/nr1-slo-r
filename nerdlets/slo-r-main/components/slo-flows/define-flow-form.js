...
import { AccountsQuery, Button, Modal, HeadingText, Spinner } from 'nr1';
      ...
      <Modal hidden={!isOpen} onClose={onClose}>
        ...
        {({ values, errors, setFieldValue, handleSubmit, resetForm }) => (
          <form onSubmit={handleSubmit}>
              ...
              />
              <div>
                <h4 style={{display: 'inline-flex'}} className="dropdown-label">Account</h4>
                <small style={{marginLeft: '12px', display: 'inline-flex'}} className="input-description">
              ...
              <h4 style={{display: 'inline-flex'}} className="dropdown-label">SLOs</h4>
              <small style={{marginLeft: '12px', display: 'inline-flex'}} className="input-description">
